  ...
  return (
    <div className="relative h-full max-w-[750px]">
      ...
      <div className="min-lg:hidden">
          ...
          <defs>
            <clipPath id="curveB2" clipPathUnits="objectBoundingBox">
              <path
                ...
                d="M0 0.3 Q0 0.2 0.091 0.2 L0.636 0.2 Q0.727 0.2 0.727 0.1 0.727 0 0.818 0 L0.909 0 Q1 0 1 0.1 L1 0.9 Q1 1 0.909 1 L0.091 1 Q0 1 0 0.9 L0 0.3"
              />
              <path
                className="md:hidden"
                d="M0 .3 Q0 .2 .091 .2 L.636 .2 Q.727 .2 .727 .1 Q.727 0 .818 0 L.909 0 Q1 0 1 .1 L1 .7 Q1 .8 .909 .8 L.091 .8 Q0 .8 0 .7 Z"
              />
            </clipPath>
          </defs>
        </svg>
        ...
        >
          <h4 className="min-[450px]:text-md leading-3 max-[450px]:text-sm min-[620px]:text-2xl">
      ...
      <motion.img
        ...
        src={explore}
        alt="Exploring food"
        className="aspect-[1/0.8] object-cover max-lg:[clip-path:url(#curveB2)] md:max-lg:aspect-[1/0.5] lg:aspect-square lg:h-full min-lg:[clip-path:url(#curveB)]"
      />
    </div>
  );
};
