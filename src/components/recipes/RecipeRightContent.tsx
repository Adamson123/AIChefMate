  ...
  return (
    <div className="relative h-full max-w-[750px]">
        ...
        <svg width="0" height="0">
          <defs>
            <clipPath id="curveB" clipPathUnits="objectBoundingBox">
              <path d="M0.0667 0.1 L0.4 0.1 A0.0667 0.05 0 0 0 0.4667 0.05 L0.4667 0.05 A0.0667 0.05 0 0 1 0.5333 0 L0.9333 0 A0.0667 0.05 0 0 1 1 0.05 L1 0.95 A0.0667 0.05 0 0 1 0.9333 1 L0.0667 1 A0.0667 0.05 0 0 1 0 0.95 L0 0.15 A0.0667 0.05 0 0 1 0.0667 0.1 Z"></path>
            </clipPath>
          </defs>
        </svg>
      ...
      <img
        src={explore}
        alt="Exploring food"
        className="aspect-[1/0.8] object-cover max-[650px]:[clip-path:url(#curveB2)] min-[650px]:[clip-path:url(#curveB)] lg:h-full"
      />
    </div>
  );
};
